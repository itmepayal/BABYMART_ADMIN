...
const EditBanner = () => {
    ...
    (async () => {
      ...
      reset({
        ...
        discountPercentage: banner.discountPercentage
          ? String(banner.discountPercentage)
          : "",
        priority: banner.priority ? String(banner.priority) : "",
      ...
      if (banner.desktopImage?.url) setDesktopPreview(banner.desktopImage.url);
      if (banner.mobileImage?.url) setMobilePreview(banner.mobileImage.url);
    })();
  }, [id]);
  ...
  return (
    <div className="min-h-screen">
      <Header
        title="Edit Banner"
        description="Update banner details, images, and settings"
        actionLabel="Back"
                  ...
                  <div className="space-y-4 p-6">
                    ...
                    <div className="grid grid-cols-2 gap-3">
                      ...
                      <div className="rounded-2xl border border-slate-200 bg-slate-50 p-3.5">
                        ...
                        <p
                          className={`mt-1 text-base font-bold ${mobileFile || mobilePreview ? "text-emerald-600" : "text-slate-400"}`}
                        >
                          {mobileFile || mobilePreview ? "Uploaded" : "None"}
                        </p>
                      </div>
                    </div>
