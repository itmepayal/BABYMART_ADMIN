    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between rounded-2xl border bg-white p-4">
        <div className="space-y-2">
          <div className="h-5 w-56 rounded bg-slate-200 shimmer" />
          <div className="h-4 w-72 rounded bg-slate-200 shimmer" />
        </div>

        <div className="h-10 w-36 rounded-xl bg-slate-200 shimmer" />
      </div>

      {/* ================= SEARCH SKELETON ================= */}
      <div className="rounded-2xl border border-slate-200 bg-white px-4 py-4 shadow-sm">
        <div className="h-11 w-full max-w-md rounded-xl bg-slate-200 shimmer" />
      </div>
                ...
                <TableRow key={index} className="border-b border-slate-100">
                  ...
                  <TableCell>
                    <div className="flex items-center gap-3">
                      ...
                      <div className="space-y-2">
                        <div className="h-4 w-36 rounded bg-slate-200 shimmer" />
